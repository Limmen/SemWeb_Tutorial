package kth.se.id2208.vt18.project.tutorial.services.kth;
...
/**
 * Endpoint representing a webservice for KTH to publish courses.
 * Upon startup the service creates some dummy-data and converts it to RDF, ready to serve future requests.
 *
 * To visit, open browser to http://localhost:8080/id2208/tutorial/institutes/kth/
 * or from shell
 * curl -H "Accept: application/rdf+xml" http://localhost:8080/id2208/tutorial/institutes/kth/
 * curl -H "Accept: text/html" http://localhost:8080/id2208/tutorial/institutes/kth/
 *
 * @author Kim Hammar on 2018-01-13.
 */
@Path("/id2208/tutorial/institutes/kth")
@Singleton
public class KTH {
    ...
    private Model constructRDF(){
        ...
        DataUtils.ID2208.toRDF(ontModel, rdfModel);
        return rdfModel;
    }
